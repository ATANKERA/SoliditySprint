...
contract SoliditySprint2022 is Ownable {
    ...
    function f15(address team, address expectedSigner, bytes memory signature) external isLive {
        ...
        //5c8aed31bcb9e9889970b4a7647843b7ab31487f575ba97a73c104aeacc53223
        //fdeb5c1a5b648fa543a8abc000b2240b37651b0e3c7584e355e3674c6de93a54429ab449a1a0554bc14020f28b856e468b63054793eda0d5437aea069d7140461b
    ...
    function f21(address team, uint value) public isLive {
        ...
        assembly {
            mstore(0, team) //0 0x88... 0x8e666Fe98cF29Ad42065C2632ccF90e54c21DFdc
            mstore(32, 1) //32, 1 
            let hash := keccak256(0, 64) //f1918e8562236eb17adc8502332f4c9c82bc14e19bfc0aa10ab674ff75b3d2f3
            result := sload(hash) //adbb793cdb40cebccc0b9e7a7b5c52ca134ee732870f8865c64174873bbe33f2
        }
